        ...
        <a href="/blog/{{ $eachblog['slug'] }}" class="font-medium text-blue-400 hover:underline">Read More &raquo</a>
              ...
              <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                  <div class="flex justify-between items-center mb-5 text-gray-500">
                      ...
                      <span class="text-sm">{{ $eachblog->created_at->diffForHumans() }}</span>
                  </div>
                  <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">{{ $eachblog['title'] }}</a></h2>
